...
export class CodeSceneTabPanel implements Disposable {
  ...
  private async presentDocumentation(params: InteractiveDocsParams, isStale = false) {
    ...
    const fnLocContent = functionLocationContent({
      ...
      fnName: issueInfo.fnName /*|| fnToRefactor?.name // CS-5069 Remove ACE */,
      isStale,
    });
    ...
    this.updateContentWithDocScripts(title, [fnLocContent, staleContent, /* buttonContent, // CS-5069 Remove ACE */ docsContent]);
  }
